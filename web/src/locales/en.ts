...
export const en = {
  ...
  analytics: {
    ...
    filtersHint: 'If needed, filter by domain and adjust sorting.',
    domainsCount: 'Showing {shown} of {total} domains',
    search: 'Search',
    domainSearchPlaceholder: 'Filter by domain',
    sortByLabel: 'Sort',
    sortOrderLabel: 'Order',
    sortByHelper: 'Sort by field:',
    sortOrderHelper: 'Order:',
    sortByTime: 'Time',
    sortByDomain: 'Domain',
    sortByCategory: 'Category',
    sortOrderDesc: 'Descending',
    sortOrderAsc: 'Ascending',
    dateRangeFromLabel: 'From date',
    dateRangeToLabel: 'To date',
  ...
  auth: {
    ...
    login: 'Sign In',
    loginWithProvider: 'Continue with {provider}',
    ...
    oauthRedirecting: 'Redirecting to {provider}...',
    oauthProcessing: 'Completing OAuth sign-in...',
    oauthProcessingTitle: 'Completing sign-in',
    oauthMissingCode: 'OAuth code or state is missing',
    oauthFailed: 'OAuth sign-in failed. Please try again.',
    oauthProviderUnsupported: 'OAuth provider is not supported',
  },
  welcome: {
    title: '🧘 Mindful Web',
